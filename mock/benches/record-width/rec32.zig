...
const Node = extern struct { op: u8, arity: u8, _p: u16 = 0, a: u32, b: u32, cc: u32, dd: u32, _q: u64 = 0 }; // 32B
...
pub fn main() void {
    ...
    for ([_]u32{5,20,40}) |cf| {
        ...
        for (lg, 0..) |l, i| nodes[i] = .{ .op = l.op, .arity = l.arity, .a = l.ops[0], .b = l.ops[1], .cc = l.ops[2], .dd = 0 };
        c.timeWalk("rec32", cf, 32, &run);
    }
}
