...
fn ha(i:usize,n:[*]const c.Node,r:[*]i64,l:usize)callconv(.c)void{r[i]=c.heavy(64,r[n[i].a],r[n[i].b]);nx(i,n,r,l);}
fn hm(i:usize,n:[*]const c.Node,r:[*]i64,l:usize)callconv(.c)void{r[i]=c.heavy(64,r[n[i].b],r[n[i].a]);nx(i,n,r,l);}
...
pub fn main()void{const a=std.heap.page_allocator;c.report("tail",64,c.gen(a),a.alloc(i64,c.N) catch unreachable,&run);}
