...
// tnum_or. Operands are built once per subprocess from a compile-time seed; the
...
#[bench_variant("tl_or", sizes = [64, 256, 1024, 4096, 16384])]
    ...
    timed! { run {
        ...
        for k in 0..ITERS {
            ...
            for i in 0..len {
                ...
                let r = { let v = a.0 | b.0; let mu = a.1 | b.1; (v, mu & !v) };
                sv ^= r.0;
