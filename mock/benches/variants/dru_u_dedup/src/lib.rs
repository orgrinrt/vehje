...
// 20% may-be-shared, strategy = hash-cons every value, id equality. Within a bench every strategy returns
...
#[bench_variant("dru_u_dedup", sizes = [64, 256, 1024, 4096, 16384])]
