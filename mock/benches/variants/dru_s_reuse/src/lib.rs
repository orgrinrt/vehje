...
// 60% may-be-shared, strategy = in-place-when-unique, structural equality. Within a bench every strategy returns
...
#[bench_variant("dru_s_reuse", sizes = [64, 256, 1024, 4096, 16384])]
