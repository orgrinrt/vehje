...
#[bench_variant("carrier_cold_wideselect_threaded", sizes = [64, 256, 1024, 4096, 16384])]
fn run<const N: usize>(input: &[u8; N], output: &mut [u8; 8]) -> FfiBenchCall {
    ...
    timed_calibrated! { run {
        ...
        while k < ITERS {
            ...
            let pd = &pds[k]; c::predecode::interpret_predecoded_threaded(pd, seed, &mut r); acc ^= c::checksum(&r);
            k += 1;
        }
