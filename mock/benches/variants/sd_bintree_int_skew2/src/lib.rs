...
static PROG: &[(u8, i16)] = &[(1u8, 2i16), (2u8, 6i16), (1u8, 3i16), (2u8, 5i16), (3u8, 3i16), (3u8, 2i16), (1u8, 1i16), (2u8, 9i16), (3u8, 1i16), (3u8, 0i16)];
#[inline(never)]
...
// SHOWDOWN interp tier: strategy `bintree`, scenario `skew2`
#[bench_variant("sd_bintree_int_skew2", sizes = [64, 256, 1024, 4096, 16384])]
