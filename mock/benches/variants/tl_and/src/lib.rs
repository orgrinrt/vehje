...
// tnum_and. Operands are built once per subprocess from a compile-time seed; the
...
#[bench_variant("tl_and", sizes = [64, 256, 1024, 4096, 16384])]
    ...
    timed! { run {
        ...
        for k in 0..ITERS {
            ...
            for i in 0..len {
                ...
                let r = { let alpha = a.0 | a.1; let beta = b.0 | b.1; let v = a.0 & b.0; (v, alpha & beta & !v) };
                sv ^= r.0;
