...
// 60% may-be-shared, strategy = intern-or-reuse chosen per site, mixed equality. Within a bench every strategy returns
...
#[bench_variant("dru_s_both", sizes = [64, 256, 1024, 4096, 16384])]
