...
// always the 64-bit long-multiplication loop. Operands (a mix ~80% both-known) are built once per subprocess from a
...
#[bench_variant("tm_loop", sizes = [64, 256, 1024, 4096, 16384])]
