...
// 60% may-be-shared, strategy = copy-on-write, structural equality. Within a bench every strategy returns
...
#[bench_variant("dru_s_plain", sizes = [64, 256, 1024, 4096, 16384])]
