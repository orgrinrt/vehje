...
// concrete. Operands are built once per subprocess from a compile-time seed; the
...
#[bench_variant("tl_concrete", sizes = [64, 256, 1024, 4096, 16384])]
    ...
    timed! { run {
        ...
        for k in 0..ITERS {
            ...
            for i in 0..len {
                ...
                let r = (a.0.wrapping_add(b.0), 0u64);
                sv ^= r.0;
