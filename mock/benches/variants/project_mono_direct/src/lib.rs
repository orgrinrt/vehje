...
// monomorphic site, strategy = direct-offset. Within a bench every strategy returns the
...
#[bench_variant("project_mono_direct", sizes = [64, 256, 1024, 4096, 16384])]
