...
static PROG: &[(u8, i16)] = &[(0u8, 3i16), (2u8, 7i16), (0u8, 2i16), (2u8, 8i16), (0u8, 1i16), (2u8, 9i16), (3u8, 0i16), (3u8, 3i16), (3u8, 2i16), (3u8, 1i16)];
#[inline(never)]
...
// SHOWDOWN interp tier: strategy `chain_rev`, scenario `skew2`
#[bench_variant("sd_chain_rev_int_skew2", sizes = [64, 256, 1024, 4096, 16384])]
