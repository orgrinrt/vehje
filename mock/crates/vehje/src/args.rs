...
pub fn single_file_arg(rest: &[String]) -> Maybe<&str> {
    // lint:allow(bare_string) reason: binary-entry plumbing; argv is OsString-shaped at the std boundary; tracked: #73 lint:allow(no-bare-string) tracked: #207
    match rest.first() {
