...
fn span(start: u32, end: u32) -> Span {
    // lint:allow(no-bare-numeric) reason: test-helper boundary, Span constructors take bare u32s until the substrate offers a typed-width span builder; tracked: #81
